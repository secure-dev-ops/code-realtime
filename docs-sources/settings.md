...
| [Diagram - Show Excluded Elements in State Diagram](#show-excluded-elements) | code-rt.diagram.showExcludedElementsInStateDiagram | Show exluded elements in state diagrams
| [Diagram - Show Excluded Elements in Structure Diagram](#show-excluded-elements) | code-rt.diagram.showExcludedElementsInStructureDiagram | Show exluded elements in structure diagrams
...
By default excluded elements are shown in state and structure diagrams with a "crossed" background or line style. If you prefer excluded elements to instead be hidden from diagrams, you can turn off this setting. Note that there are actually two settings here; one for state diagrams and one for structure diagrams. See [Diagram Filters](working-with-art/diagrams.md#diagram-filters) for more information.
